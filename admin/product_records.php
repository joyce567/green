					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<?php echo "<td> <a href='view-product.php?id=".$row['id']."' class='btn btn-success'>View</a></td>"?>
								<?php echo "<td> <a href='update-product.php?id=".$row['id']."' class='btn btn-primary'>Update</a></td>"?>
								<?php echo "<td> <a href='delete-product.php?id=".$row['id']."' class='btn btn-danger'>Delete</a></td>"?>
							</tr>
							<?php
							}
							?>
